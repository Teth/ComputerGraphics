...
public class Duck extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // body
        var body1 = new MoveTo(420, 300);
        var body2 = new QuadCurveTo(481,244, 408, 193);
        var body3 = new LineTo(331, 197);
        var body4 = new LineTo(290, 162);
        var body5 = new QuadCurveTo(270, 140, 267 , 183);
        var body6 = new QuadCurveTo(234, 245, 280, 284);
        var body7 = new QuadCurveTo(345, 312, 420, 300);
        ...
        var eyeBack = new Ellipse(405, 138, 6, 7);
        ...
        var eyeFront = new Ellipse(406, 136, 3, 4);
        ...
        var nose2 = new QuadCurveTo(446, 139, 463, 133);
